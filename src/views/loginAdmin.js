        ...
        <div className={` container-LoginAdmin ${isToggled ? 'dark-mode' : ''}`}>
            <div className="containerLogin">
                <div className='container-LoginImages'>
                    ...
                    <img className='imageAdmin ' src={require('../assets/image-logo/loginbanner-e591ea61.png')} alt="Login Banner" />
                ...
                <div className="ContainerLoginAdminif">
                    ...
                    <div className="login">
                        ...
                        <div className="Chaiconemail" id="Chaiconemail" >
                            <i className="fa-solid fa-envelope" ClassName="iconemail" id="fa-envelope"></i>
                            <input
                        ...
                        <div className="chaiconlock" id="chaiconlock">
                            <i className="fa-solid fa-lock" ClassName="iconemail" id="fa-lock"></i>
                            <input
                                type="password"
                        ...
                        <div className="dangnhapp">
                            <p style={{ color: 'gray' }}>
                                ...
                                -{' '}
                                <a href="https://www.facebook.com/minute2701/" className="taotaikhoan">
                                    Quên mật khẩu
                                </a>
                            </p>
                        </div>
